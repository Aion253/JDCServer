...
public class ContentLoader {
	...
	/**
	 * Instantiates a class, given its fully qualified name, after its archive's {@link URL} has been added into the JVM via a {@link URLClassLoader} and the method {@link ContentLoader#initializeClassLoader()}.
	 * <p>
